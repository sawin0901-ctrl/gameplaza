    ...
    <div className="p-6 max-w-6xl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {([
          ...
          { label: "Заказов сегодня", value: ordersToday.toLocaleString("ru"), sub: revenue > 0 ? revenue.toLocaleString("ru") + " руб." : "нет выручки", icon: "🧾", color: ordersToday > 0 ? "text-emerald-400" : "text-[var(--text-3)]" },
        ] as const).map(s => (
        ...
        <div className="card p-5">
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            {([
              ...
              <div key={s.label} className="bg-[var(--bg)] rounded-xl p-3 border border-[var(--border)]">
        ...
        <div className="card p-5">
          ...
          <div className="space-y-3">
            {([
              ...
              { label: "Товаров скрыто", value: hiddenProducts, warn: hiddenProducts > 100, href: "/admin/products" },
            ] as const).map(s => (
      ...
      {/* Быстрые действия + история импортов */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div className="card p-5">
          <h3 className="font-semibold text-[var(--text)] mb-3">Быстрые действия</h3>
          <div className="space-y-2">
            <Link href="/admin/import/plati" className="btn-primary w-full py-2.5 text-sm">Импорт Plati.Market</Link>
