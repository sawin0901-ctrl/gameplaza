    ...
    <footer className="bg-[#0d0d14] border-t border-[#1f2937] mt-20">
      <div className="max-w-7xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg"><span className="text-brand">Game</span><span className="text-white">Plaza</span></span>
            </Link>
            <p className="text-gray-600 text-sm leading-relaxed">
              Маркетплейс цифровых товаров. Игры, программы, подписки и ключи активации по лучшим ценам.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2.5">
                ...
                <span className="text-gray-600 text-sm">support@gameplaza.site</span>
              </div>
              <div className="flex items-start gap-2.5">
                <svg className="w-4 h-4 text-brand mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-gray-600 text-sm">Ответ в течение 24 часов</span>
              </div>
            </div>
            <div className="mt-6">
              ...
              <div className="flex gap-2 flex-wrap">
                {["Visa", "MC", "МИР", "СБП"].map(p => (
                  <span key={p} className="px-2.5 py-1 bg-[#1a1a26] border border-[#1f2937] rounded-lg text-xs text-gray-500">{p}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-[#1f2937] mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <p className="text-gray-800 text-xs">gameplaza.site</p>
        </div>
      </div>
    </footer>
  )
